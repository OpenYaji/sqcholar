...
import { Facebook, Instagram, Twitter,BadgeHelp} from "lucide-react";
...
{/* Chat Support sa leftside corner */}
          <div className="relative">
            <div className="fixed bottom-8 left-8 group">
              ...
              <span className="absolute bottom-20 left-1/2 -translate-x-1/2 bg-blue-700 text-white text-xs rounded-md py-1 px-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
                Chat Support
              </span>
            </div>
          </div>
